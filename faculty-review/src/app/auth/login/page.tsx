    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-petal to-blush-50 flex items-center justify-center p-4">
      ...
      >
        <Link href="/" className="flex items-center justify-center gap-1 mb-8">
          <span className="font-sans font-bold text-2xl text-gray-800">
            Faculty
          </span>

          <span className="font-display italic font-semibold text-2xl text-blush-500">
            {" "}
            Review
          </span>
        ...
        <div className="card p-6 sm:p-8">
          ...
          <p className="text-center text-sm text-gray-500 mt-5">
            ...
            <Link
              href="/auth/signup"
              className="text-blush-500 font-semibold hover:underline"
            >
              Sign up free
            </Link>
          </p>
